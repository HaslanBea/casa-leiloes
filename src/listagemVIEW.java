...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "ID inválido. Por favor, insira um número.");
        } catch (Exception e) {
            javax.swing.JOptionPane.showMessageDialog(this, "Erro ao vender o produto: " + e.getMessage());
        }
    }
    ...
    private void listarProdutos() {
        try {
            ...
            model.setNumRows(0); // Limpa os dados da tabela antes de adicionar novos
